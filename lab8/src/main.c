...
{
    GPIOB->ODR &= ~0x1000;
    bb_write_bit(halfword >> 15 & 0x1);
    bb_write_bit(halfword >> 14 & 0x1);
    bb_write_bit(halfword >> 13 & 0x1);
    bb_write_bit(halfword >> 12 & 0x1);
    bb_write_bit(halfword >> 11 & 0x1);
    bb_write_bit(halfword >> 10 & 0x1);
    bb_write_bit(halfword >> 9 & 0x1);
    bb_write_bit(halfword >> 8 & 0x1);
    bb_write_bit(halfword >> 7 & 0x1);
    bb_write_bit(halfword >> 6 & 0x1);
    bb_write_bit(halfword >> 5 & 0x1);
    bb_write_bit(halfword >> 4 & 0x1);
    bb_write_bit(halfword >> 3 & 0x1);
    bb_write_bit(halfword >> 2 & 0x1);
    bb_write_bit(halfword >> 1 & 0x1);
    bb_write_bit(halfword >> 0 & 0x1);
    GPIOB->ODR |= 0x1000;
}
...
void init_spi1() {
    ...
    SPI1->CR2 = SPI_CR2_DS_0 | SPI_CR2_DS_3 | SPI_CR2_SSOE | SPI_CR2_NSSP | SPI_CR2_TXDMAEN;
...
void spi1_setup_dma(void)
{
    ...
    DMA1_Channel3->CCR &= ~(0x00000f00);
    DMA1_Channel3->CCR |= (0x00000500);
...
//#define BIT_BANG
    ...
    // Direct SPI peripheral to drive LED
